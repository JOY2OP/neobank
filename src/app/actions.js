...
import { issueStripeCard } from "@/lib/providers/stripe";
...
export async function issueCardAction(_previous, formData) {
  try {
    ...
    const issued = await issueStripeCard(cardholder);
    ...
    await insertRows("card_events", [{
      ...
      details: { cardholder_id: issued.cardholderId, source: issued.source },
    }]);
