...
export default async function CardsPage() {
  ...
  return (
    <>
      <SectionHeading eyebrow="Lithic Issuing" title={user.role === "OWNER" ? "Team cards" : "Your card"} description="Only Lithic's opaque token and masked card data are stored in Corgi." />
